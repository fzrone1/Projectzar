<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      {{-- <img src="{{asset('assets/dist/img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8"> --}}
      {{-- <span class="brand-text"><font color="#e5ba85"><b>{{ Auth::user()->name }}</b></font></span> --}}
      {{-- <img src="{{asset('/images/logos/logompp.png')}}" style="max-width: 40%;"> --}}
      {{-- <img src="{{asset('/images/logos/smart.png')}}" style="max-width: 20%;"> --}}

      <span class="brand-text"><b>HRD System</b></span>
    </a>
